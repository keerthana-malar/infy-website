...
function Webblog() {
  ...
  const blogFiltered = blogs.filter(
    (val, index) => val.category === "Web and App"
  );
        ...
        <div className="blogbx1">
          ...
          <div className="sercon">
            ...
            >
              <Link
                to="/mainblogs"
                className="btns text-center text-light-blogss"
              >
            ...
            {blogFiltered.map((blog, index) => (
              <div className="blogin">
                ...
                <div className="blgconbx">
                  ...
                  <div className="bgconbx mb-2">{blog.title}</div>
