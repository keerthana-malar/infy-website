      ...
      <div className="service-slider">
        <Slider className="serv-sliders" {...settings}>
          <div className="servsl-head">
            <Link
              to="https://infygain.com/onlinestore/products/ca/178"
              target="_blank"
            >
              <img src="/images/iot-network.webp" alt="best services" />
            </Link>
          ...
          <div className="servsl-head">
            <Link
              ...
              target="_blank"
            >
              <img src="/images/iot-laptop.webp" alt="best services" />
            </Link>
            <div className=" servsl-overlay">
          ...
          <div className="servsl-head">
            ...
            >
              {" "}
              <img src="/images/iot-camera.png" alt="best services" />
            </Link>
            <div className=" servsl-overlay">
          ...
          <div className="servsl-head">
            <Link
              ...
              target="_blank"
            >
              <img src="/images/iot-projectors.png" alt="best services" />
            </Link>
            <div className=" servsl-overlay">
          ...
          <div className="servsl-head">
            <Link
              ...
              target="_blank"
            >
              <img src="/images/PC.webp" alt="best services" />
            </Link>
            <div className=" servsl-overlay">
          ...
          <div className="servsl-head">
            <Link
              ...
              target="_blank"
            >
              <img src="/images/lapcon.webp" alt="best services" />
            </Link>
            <div className=" servsl-overlay">
        ...
        <div className="serv-details3">
          ...
          <div className="serv-details4">
            <button onClick={downloadPdf}>
              ...
              &nbsp;<span className="serv-btn-cont">Download Brochure</span>{" "}
            </button>
          </div>
        </div>
      </div>
