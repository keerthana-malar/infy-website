        ...
        <div className='container'>
            <div className="privacy-policy-container">
                ...
                <p className='text-muted privacy-para-con'>
                    This website is operated by Infygain Technologies.
                    Throughout the site, the terms “we”, “us” and “our”
                    refer to Infygain Technologies. Infygain Technologies offers this website,
                ...
                <p className='text-muted privacy-para-con'>
                    ...
                    use of or access to the website following the posting of any changes constitutes acceptance of those
                    changes.
                </p>
                {/* section1 */}

                <h2 className="section-headings">SECTION 1 - ONLINE STORE TERMS</h2>
                <p className='text-muted privacy-para-con'>
                    By agreeing to these Terms of Service, you represent that you are at least the age of
                    majority in your state or province of residence, or that you are the age of majority in your state or province of residence and you
                ...
                <h2 className="section-headings">SECTION 2 - GENERAL CONDITIONS</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 5 - PRODUCTS OR SERVICES</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
                <p className='text-muted privacy-para-con'>
                    We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit or cancel quantities purchased per person, per household or per order. These restrictions may include orders placed by or under the same customer account, the same credit card, and/or orders that use the same billing and/or shipping address. In the event that we make a change to or cancel an order, we may attempt to notify you by contacting the e-mail and/or billing address/phone number provided at the time the order was made. We reserve the right to limit
                    or prohibit orders that, in our sole judgment, appear to be placed by dealers, resellers or distributors.
                </p>
                <p className='text-muted privacy-para-con'>
                    You agree to provide current, complete and accurate purchase and account information for all purchases made at our store. You agree to promptly update your account and other information, including your email address and credit
                ...
                <h2 className="section-headings">SECTION 7 - OPTIONAL TOOLS</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 8 - THIRD-PARTY LINKS</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 10 - PERSONAL INFORMATION</h2>
                <p className='text-muted privacy-para-con'>
                    Your submission of personal information through the store is governed by our Privacy Policy.
                </p>
                {/* section11*/}

                <h2 className="section-headings">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 12 - PROHIBITED USES</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <p className='text-muted privacy-para-con'>
                    In no case shall Infygain Technologies, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
                </p>
                {/* section14*/}

                <h2 className="section-headings">SECTION 14 - INDEMNIFICATION</h2>
                <p className='text-muted privacy-para-con'>
                    You agree to indemnify, defend and hold harmless SInfygain Technologies and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
                </p>
                {/* section15*/}

                <h2 className="section-headings">SECTION 15 - SEVERABILITY</h2>
                <p className='text-muted privacy-para-con'>
                    In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.
                </p>
                {/* section16*/}

                <h2 className="section-headings">SECTION 16 - TERMINATION</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 17 - ENTIRE AGREEMENT</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 18 - CHANGES TO TERMS OF SERVICE</h2>
                <p className='text-muted privacy-para-con'>
                ...
                <h2 className="section-headings">SECTION 19 - CONTACT INFORMATION</h2>
                <p className='text-muted privacy-para-con'>
                    Questions about the Terms of Service should be sent to us at Contact :+91 99521 41444 / Email : info[at]infygain[dot]com
                </p>
            </div>
        </div >
        <Footer/>
