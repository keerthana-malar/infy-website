                    ...
                    <div className='row'>
                        <div className='col-md-7'>
                            <div className=' contentsection'>
                                ...
                                <p className='bannercontent' >Discover lightning-fast Internet, crystal-clear Voice, and immersive IPTV entertainment with Infygain technologies, your trusted ISP. Explore our broadband solutions, unbeatable connectivity, and competitive pricing today.</p>
                            ...
                            <div className='lists'>
                                ...
                                <div className='button'><button className='btns-green'>see plan & deals</button></div>
                        </div>
                    </div>
                    </div>
                </div>
