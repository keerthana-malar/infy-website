    ...
    <>
      <div className="container mt-4">
        <div className=" maincontent">
          ...
          <p className="text-muted contactpara">
            Welcome to Infygain Technologies. If you have any questions or
            inquiries, please don't hesitate to <br></br>contact us using the
            information below:
          </p>
          <br></br>
          <div className="cont">
                ...
                <div className="row">
                  <div className="conbox1">
                    ...
                    <div className="col-md-9">
                      ...
                      <p className="text-muted locacon">
                        {" "}
                        <a href="tel:+919952141444" className="text-muted">
                          +91 99521&nbsp;&nbsp;&nbsp;41444
                        </a>{" "}
                        <br />{" "}
                        <a href="tel:+919087724444" className="text-muted">
                          +91 90877&nbsp;&nbsp;&nbsp;24444
                        </a>
                      </p>
                    </div>
