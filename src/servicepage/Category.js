        ...
        <>
          <div className="container mt-5 mp-5">
            ...
            <div className="biod biode">
              ...
              >
                Infygain Technologies: Unlock boundless potential with our
                precision-engineered laptops, fortified with cutting-edge
              ...
              >
                <p>
                  Discover a redefined standard of laptop performance. Our
                  relentless focus on user satisfaction, paired with
                  leading-edge technology, establishes us as the go-to choice
                  for those seeking unparalleled computing. Elevate your
                  computing experience with us – where excellence meets
                  innovation
                </p>
              </div>
            </div>
          ...
          <div className="container mt-5 mp-5">
            ...
            <div className="biod biode">
              <h2
                ...
                data-aos-duration="1500"
              >
                Infygain Technologies: Experience unparalleled power and
                reliability with our meticulously crafted desktops. Elevate your
                setup with top-tier performance and robust security, setting new
              ...
              >
                <p>
                  Embrace a new benchmark in desktop computing. Our steadfast
                  commitment to user satisfaction, combined with cutting-edge
                  technology, positions us as the ultimate choice for those
                  pursuing unparalleled performance. Elevate your computing
                  prowess with us – where excellence intersects with innovation
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="subcategoryhead" key={index}>
                    <div className="subcategory2 ">
                      <img
                        ...
                        src={`${
                          val.id === 1
                            ? "/images/brandeddesk.webp"
                            : val.id === 2
                            ? "/images/assmble-desk.webp"
                            : val.id === 3
                            ? "/images/work-desk.webp"
                            : val.id === 4
                            ? "/images/game-desk.webp"
                            : ""
                        }`}
                        alt={val.title}
                        title={val.title}
                      ...
                      <img
                        src={`${
                          val.id === 1
                            ...
                            ? "/images/Router.webp"
                            : val.id === 4
                            ? "/images/firewall-img.webp"
                            : val.id === 5
                            ? "/images/end point security.webp"
                            : val.id === 6
                            ? "/images/fibre.webp"
                            : ""
                        }`}
                      ...
                      <img
                        src={`${
                          val.id === 1
                            ? "/images/anolog.webp"
                            : val.id === 2
                            ? "/images/IP-Network-Mini-Bullet-Camera.webp"
                            : val.id === 3
                            ? "/images/DVRCCTV.webp"
                            : val.id === 4
                            ? "/images/NVRCCTV-CAMERA.webp"
                            : val.id === 5
                            ? "/images/360.webp"
                            : val.id === 6
                            ? "/images/ptz.webp"
              ...
              {Projectors.map((val, index) => (
                <>
                  <div className="subcategoryhead" key={index}>
                    <div className="subcategory2 ">
                      <img
                        className={val.id === 3 ? "cat-pro1" : ""}
                        src={`${
                          val.id === 1
                            ? "/images/led projector.webp"
                            : val.id === 2
                            ? "/images/lcd-projector.webp"
                            : val.id === 3
          ...
          <div className="container mt-5 mp-5">
            ...
            <div className="biod biode">
              <h2
                ...
                data-aos-duration="1500"
              >
                Infygain Technologies: Print with precision and reliability
                using our advanced printers. Elevate your efficiency with sharp,
              ...
              >
                <p>
                  At Infygain Technologies, redefine your printing standards.
                  Our commitment to customer satisfaction, coupled with
                  cutting-edge technology, makes us the preferred choice for
                  those seeking high-quality printing solutions. Elevate your
                  printing experience with us – where excellence converges with
                  innovation.
                </p>
              </div>
            </div>
                      ...
                      <img
                        ...
                        src={`${
                          val.id === 1
                            ...
                            ? "/images/thermal.webp"
                            : val.id === 3
                            ? "/images/color-printer.webp"
                            : val.id === 4
                            ? "/images/multi.webp"
                            : val.id === 5
                            ? "/images/dot-matrix.webp"
                            : ""
                        }`}
                        alt={val.title}
                        title={val.title}
          ...
          <div className="container mt-5 mp-5">
            ...
            <div className="biod biode">
              <h2
                ...
                data-aos-duration="1500"
              >
                Infygain Technologies: Capture perfection with our
                high-performance scanners. Elevate your scanning experience with
              ...
              >
                <p>
                  ...
                  for those seeking superior scanning solutions. Streamline your
              ...
              {pos.map((val, index) => (
                <>
                  <div className="subcategoryhead" key={index}>
                    <div className="subcategory2 ">
                      <img
                        className={val.id === 3 ? "cat-desk2" : ""}
                        src={`${
                          val.id === 1
                            ? "/images/posoverall.webp"
                            : val.id === 2
                            ? "/images/kiosk.webp"
                            : val.id === 3
                            ? "/images/billingapp-web.webp"
                            : ""
                        }`}
                        alt={val.title}
                        title={val.title}
