  ...
  return (
    <div className='container serv-acc-head'>
        <div className='serv-accd-btn'>
            ...
            <button className={`${show === 'pc3' ? "active" : ""}`} onClick={() => setShow('pc3')}>Our Values</button>
            <hr />
        </div>
        ...
        { show === 'pc1' && 
         ...
         { show === 'pc3' && 
            <>
                 <div className='serv-accd-cont'>
                    <p className='sev-cont1'>Our values is customer satisfaction is at the heart of everything we do. We prioritize understanding our clients' needs, offering tailored solutions, and providing exceptional service to guarantee a positive.</p>
