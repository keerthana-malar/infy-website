          ...
          <div className="row align-items-center indeed">
            ...
            <div className="col-md-4 leftContBox">
              <div className="leftparagraph">
                ...
                <h1 className="ser-h1">
                  We provide the <span className="span2">best services.</span>
                </h1>
                <p className="box1_para text-muted">
                  We understand that each client is unique, and we tailor our
                  services to meet your specific needs.
                </p>

                <button className="about-btns">
                  <span className="about-sc"></span>
                  <span
                    className="iot-about-text"
                    ...
                    <div className="row logo">
                      ...
                      <div className="col-md-8 text">
                        ...
                        <p className="right_para">
                          Network Solutions provides web services such as web
                  ...
                  >
                    <div className="row logo">
                      ...
                      <div className="col-md-8 text">
                        <h4>
                          {" "}
                          Laptop / Desktop <br></br>Sales, Service
                        </h4>
                        <p className="right_para">
                          Advises customers on technical matters and recommends
                          appropriate.
                        </p>
                      </div>
                      {/* hidden row */}
                  ...
                  >
                    <div className="row ">
                      ...
                      <div className="col-md-8 text">
                        ...
                        <p className="right_para">
                          Enhance security with our advanced CCTV and biometric
                  ...
                  >
                    <div className="row ">
                      ...
                      <div className="col-md-8 text">
                        <h4>AV Solutions</h4>
                        <p className="right_para">
                          Audio and video solutions used for improved
