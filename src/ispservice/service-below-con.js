            ...
            <div className=' container service-below-sec'>
                <div className='row align-items-center'>
                    <div className='col-md-6 con-boxse' data-aos="zoom-in-right" data-aos-duration="2000">
                        <div className='button '><Link to="/about"><button className='btns-greens'>WHO WE ARE</button></Link></div>
                    ...
                    <div className='col-md-6  bocximage' data-aos="zoom-in-right" data-aos-duration="2000">
                        <img src="/images/banner/green-man.webp" alt="best isp services" className=' img-fluid experience'title='Empowering wifi technology'></img>
                    </div>
                </div>
            </div>
        </>
