            ...
            <div className="sb sbox1">
              ...
              >
                <img
                  ...
                  src="./images/seo/websiteimg.webp"
                  title="top seo services"
                ></img>
              </div>
              <div className="st">Websites</div>
              <div className="scon text-muted">
                We sketch the essential requirement listed out by clients and
                satisfy them. We provide custom website design and development
                solutions that are not only visually striking but also optimized
            ...
            <div className="sb sbox2">
              ...
              >
                <img
                  ...
                  src="./images/seo/seoimg.webp"
                  title="top seo services"
                ></img>
              </div>
              <div className="st">SEO</div>
              <div className="scon text-muted">
                Our main motive is to eventually diminish the buffering in our
                websites. SEO is an investment just like a tree that needs
                effort, patience and time to grow before you can see the result,
                ultimately leading.
              </div>
            ...
            <div className="sb sbox4">
              ...
              >
                <img
                  className="fluid"
                  alt="top seo services"
                  src="./images/seo/graphicimg.webp"
                  title="top seo services"
                ></img>
              </div>
              <div className="st">Designing</div>
              <div className="scon text-muted">
                We provide a customized crafted design that will help your
                customers to fascinate. And that helps to align with your brand
                identity and engage your audience. We offer a wide range of
                design solutions.
              </div>
