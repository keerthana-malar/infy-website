      ...
      <div className="container mt-4">
          ...
          <div className="col-md-8 marketing">
            ...
            <div className="partnerrow">
              ...
              <div className="paraqueen">
                <p>
                  Partners are expected to be reliable and dependable, creating
                  a foundation of trust in the relationship. Partners provide
                  emotional, practical, and moral support during challenging
                  times and in achieving common goals.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row titlebox">
            <div
              className="col-md-7 box1withtexttitle"
              data-aos="fade-right"
            ...
            <div
              className=" col-md-4 partnerphototitle"
              data-aos="fade-left"
              data-aos-duration="1000"
            >
              <img
        ...
        <div className="row firstonebox">
          <div
            className="col-md-8 box1withtext"
            data-aos="fade-right"
            data-aos-duration="1000"
          >
            ...
            <p className="parabullet">
              ...
              9001:2015 and GeM authorization establish us as a trusted IT brand
              in Coimbatore in the area of Sales and Services of IoT products.
              We specialize in building IT Infrastructure for Institutes and
              Industries, boasting a strong vendor network with over 100 top
              brands. Our experienced team excels in various IT skills, enabling
              us to drive Digital Transformation affordably. We pride ourselves
              on customer success stories, geographic reach, industry
              partnerships, and staying at the forefront of technology trends.
              Committed to quality and innovation, we look ahead to a future of
              expanding services and embracing emerging technologies.
            </p>
          </div>
          <div
            className=" col-md-4 partnerphoto"
            data-aos="fade-left"
            data-aos-duration="1000"
          >
        ...
        <div className="row align-items-center">
          <div className="col-lg-4 mb-3" data-aos="fade-right">
            <img
              ...
              alt="best partners"
              className="firstsideimg"
            />
          </div>
          <div className="col-lg-8 mb-3  con-img-bac" data-aos="fade-left">
            <h2 className="itfieldtitle">Why to Invest in IT Field?</h2>
            <p className="parapiquename">
              Investing in the IT field is lucrative due to constant innovation
              and technological advancements. The sector offers global reach and
              scalability, allowing companies to tap into a wide audience and
        ...
        <div className="row firstonebox">
          <div
            className="col-lg-8 box1withtext"
            data-aos="fade-right"
            data-aos-duration="1000"
          >
            <p className="parabullet">
              IT business in India is projected to total $124.6 billion in 2024,
              an increase of 10.7% from 2023, according to the latest forecast
              by Gartner, Inc. with expansions in the key areas like digital
              transformation, cloud computing, cybersecurity, and artificial
              intelligence.
            </p>
            <p className="parabullet">
          ...
          <div
            className=" col-lg-4 partnerphoto"
            data-aos="fade-left"
            data-aos-duration="1000"
          >
            <img
        ...
        <div className="container form-head">
          ...
          <form className="careerForm">
            ...
            <div className="form-input">
              ...
              <label
                className={`radioLabel ${
                  selectedOption === "Business" ? "selected" : ""
                }`}
              >
                <input
                  type="radio"
