  ...
  Aravakurichi: [
    {
      ...
      speed: "10 Mbps",
      price: 499,
      imageUrl: "../images/banner/Group 1 copys.webp",
    ...
    },
    {
      ...
      speed: "50 Mbps",
      price: 699,
      imageUrl: "../images/banner/Group 2 copys.webp",
      con1: "Unlimited Internet",
    ...
    },
    {
      ...
      speed: "75 Mbps",
      price: 1499,
      imageUrl: "../images/banner/Group 3 copys.webp",
      con1: "Unlimited Internet",
...
function MyPackages() {
  ...
  return (
    <div
      className="container packages-container"
      data-aos="fade-up"
    ...
    >
      ...
      <div className=" head-pac-h">
        <div className=" gre-box">
          ...
          <p className="text-muted locationcontent">
            {" "}
            we provide high-speed internet solutions to keep you connected in
            today's digital world. Whether you're a casual user, a gamer, a
            business owner, or a streaming enthusiast, we have the perfect
            internet package to meet your specific needs.
          </p>
          ...
          {packages.map((pkg, index) => (
            ...
            >
              <div className="serviceContent-thiban">
                ...
                <p className="midesss-title">{pkg.con1}</p>{" "}
                <hr className="text-muted"></hr>
                <p className="midesss-title">{pkg.con2}</p>{" "}
                <hr className="text-muted"></hr>
                <p className="midesss-title">{pkg.con3}</p>{" "}
                <hr className="text-muted"></hr>
                <p className="midess-title">{pkg.speeds}</p>
                <hr className="text-muted"></hr>
                <p className="midesss-title">{pkg.adcon1}</p>
                <hr className="text-muted"></hr>
