      ...
      <div className="container">
        <div className="privacy-policy-container">
          ...
          <p className="text-muted privacy-para-con">
            Infygain Technologies knows that you care how information about you
            is used and shared, and we appreciate your trust in us to do that
            carefully and sensibly. By registering with InfyStore, you are
            accepting and consenting to the practices described here.
          </p>
          <ul className="list-privacy-con text-muted">
            <li className="privacy-para-con ">
              Any information you provide when placing an order is held in the
              strictest confidence. When placing an order you are required to
              provide us with the following information: Name, Billing address,
              Delivery address, Contact number, E-mail address for confirmation
              of the order. This information is used for delivery, billing
              purposes, latest offers, promotions and to fulfil your order.
            </li>
            <li className="privacy-para-con">
              Any personal information provided to or to be gathered by
              InfyStore is controlled primarily by Infygain Technologies.
            </li>
          </ul>
          <p className="text-muted privacy-para-con">
            Access to and use of password protected and / or secure areas of
            this website are restricted to authorized visitors only.
            Unauthorized visitors attempting to access these areas of the
          ...
          <p className="text-muted privacy-para-con">
            ...
            info@infygain.com or mailing us at: hari complex opp.prozone mall,
            Sathy Rd, Saravanampatti, Coimbatore, Tamil Nadu 641035{" "}
          </p>
          {/* section3*/}
          ...
          <p className="text-muted privacy-para-con">
            ...
            processing payment. Your purchase transaction data is only usedsar
          ...
          <p className="text-muted privacy-para-con">
            ...
            <a href="mailto:info@infygain.com" className="contact-link">
              info@infygain.com
            </a>{" "}
            or by mail at:
          </p>
