      ...
      <div className="container">
        <div className="privacy-policy-container">
          ...
          <p className="text-muted privacy-para-con">
            This website is operated by Infygain Technologies. Throughout the
            site, the terms “we”, “us” and “our” refer to Infygain Technologies.
            Infygain Technologies offers this website, including all
          ...
          <p className="text-muted privacy-para-con">
            In no case shall Infygain Technologies, our directors, officers,
          ...
          <p className="text-muted privacy-para-con">
            You agree to indemnify, defend and hold harmless SInfygain
            Technologies and our parent, subsidiaries, affiliates, partners,
          ...
          <p className="text-muted privacy-para-con">
            ...
            :+91 99521 41444 / Email : info[at]infygain[dot]com
          </p>
        </div>
      </div>
      <Footer />
