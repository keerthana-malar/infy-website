      ...
      <div className="container">
        ...
        <div className=" Ourservice_leftside">
          <div className=" header1">
            ...
            <p className="service-head">
              Discover a world of possibilities with our comprehensive range of
          ...
          <div className=" header2 text-muted">
            <p>
              Join us on a journey of digital excellence. Let's shape your
              vision into reality and take your online presence and technology
        ...
        <div className="container rightsidegrid">
          ...
          <div className="firstrow" data-aos="zoom-in-right">
            ...
            <div className="divideline"></div>
            <p className="param">
              Empower your business with our comprehensive network solutions,
          ...
          <div className="firstrow" data-aos="zoom-in-right">
            <div className="divline"></div>
            <TfiLayoutMediaCenterAlt className="icons" />
            <h3>Laptop / Desktop Sales and Service</h3>
            <div className="divideline"></div>
            <p className="param">
              Upgrade your tech seamlessly with our top-notch laptop and desktop
              solutions, offering expert sales and service.
            </p>
            {/* <div className='iconbox'> */}
            <TfiLayoutMediaCenterAlt className="icon2" />
            {/* </div> */}
          ...
          <div className="firstrow" data-aos="zoom-in-right">
            ...
            <div className="divideline"></div>
            <p className="param">
              Secure peace of mind with our streamlined security solutions –
          ...
          <div className="firstrow" data-aos="zoom-in-right">
            ...
            <div className="divideline"></div>
            <p className="param">
              Illuminate your presentations with our powerful projectors –
              delivering clarity, brilliance, and impactful visuals for every
              projection need.
            </p>
            {/* <div className='iconbox'> */}
            <SiWebtrees className="icon2" />
          ...
          <div className="firstrow" data-aos="zoom-in-left">
            ...
            <div className="divideline"></div>
            <p className="param">
              Elevate your setup with our premium computer accessories – the
              perfect blend of style, functionality, and performance for a
          ...
          <div className="firstrow" data-aos="zoom-in-left">
            ...
            <div className="divideline"></div>
            <p className="param">
              Immerse yourself in entertainment with our sleek and cutting-edge
              TVs – where stunning visuals meet unparalleled viewing
              experiences.
            </p>
            <LuLaptop2 className="icon2" />
            {/* {Hidden} */}
          ...
          <div className="firstrow" data-aos="zoom-in-left">
            ...
            <div className="divideline"></div>
            <p className="param">
              Efficiency meets precision with our advanced printers and scanners
              – empowering your workspace with seamless document handling and
          ...
          <div className="firstrow" data-aos="zoom-in-left">
            ...
            <div className="divideline"></div>
            <p className="param">
              Transform collaboration with our interactive panels – where
              innovation meets engagement for dynamic and productive meetings
              and presentations.
            </p>
            <MdNetworkWifi3Bar className="icon2" />
            {/* {Hidden} */}
          ...
          <div className="firstrow" data-aos="zoom-in-right">
            ...
            <div className="divideline"></div>
            <p className="param">
              Reliable power protection starts here. Explore our UPS solutions –
              ensuring uninterrupted performance and peace of mind for your
              critical systems.
            </p>
            {/* <div className='iconbox'> */}
            <MdNetworkWifi3Bar className="icon2" />
          ...
          <div className="firstrow" data-aos="zoom-in-right">
            ...
            <div className="divideline"></div>
            <p className="param">
              Experience connectivity without limits. Our WiFi solutions
              redefine seamless and high-speed internet access, ensuring a world
              of connectivity at your fingertips.
            </p>
            {/* <div className='iconbox'> */}
            <TfiLayoutMediaCenterAlt className="icon2" />
            {/* </div> */}
          ...
          <div className="firstrow" data-aos="zoom-in-right">
            ...
            <div className="divideline"></div>
            <p className="param">
              Your point of solution – where challenges meet innovation, and
              seamless resolutions redefine success.
            </p>
            {/* <div className='iconbox'> */}
            <GiCctvCamera className="icon2" />
            {/* </div> */}
          ...
          <div className="firstrow" data-aos="zoom-in-right">
            ...
            <div className="divideline"></div>
            <p className="param">
              Stay connected effortlessly with our intercom solutions –
              redefining communication simplicity for seamless and secure
              conversations.
            </p>
            {/* <div className='iconbox'> */}
            <SiWebtrees className="icon2" />
