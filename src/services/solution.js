        ...
        <div className="sl">
          <div className="solbox solbx2">
            <div className="solimgbx">
              <img className="img-fluid" alt="best seo services" src="./images/seo/expert.png" title="best seo services"></img>
            </div>
          ...
          <div className="solbox solbx3">
            <div className="solimgbx">
              <img className="img-fluid" alt="best seo services" src="./images/seo/progress.png" title="best seo services"></img>
            </div>
          ...
          <div className="solbox solbx4">
            <div className="solimgbx">
              <img className="img-fluid" alt="best seo services" src="./images/seo/update.png" title="best seo services"></img>
            </div>
          ...
          <div className="solbox solbx5">
            <div className="solimgbx">
              <img className="img-fluid" alt="best seo services" src="./images/seo/achieve.png" title="best seo services"></img>
            </div>
